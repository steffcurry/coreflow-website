  ...
  return (
    <div className="w-full">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-16">
          {phases.map((phase, index) => (
            <AnimatedSection
              ...
              variant="floatUp"
              delay={index * 100}
              className="glass-effect p-8 rounded-lg hover:shadow-xl hover:shadow-[#DAA520]/10 transition-shadow duration-300"
            >
              <div className="flex items-start space-x-6 mb-6">
                <div className="w-16 h-16 bg-[#4F7DF3] rounded-full flex items-center justify-center flex-shrink-0 animate-glow shadow-lg shadow-[#DAA520]/30">
                  <span className="text-2xl font-bold text-white">{phase.number}</span>
                </div>
                <div>
                  <h2 className="text-3xl font-bold mb-2 text-white">{phase.title}</h2>
        ...
        <AnimatedSection className="mt-16 glass-effect p-8 rounded-lg text-center hover:shadow-xl hover:shadow-[#DAA520]/10 transition-shadow duration-300">
          <h3 className="text-2xl font-bold mb-4 text-white">Reduce Fear, Increase Predictability</h3>
