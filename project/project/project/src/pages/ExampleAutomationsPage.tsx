    ...
    <div className="w-full">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <AnimatedSection className="max-w-3xl mx-auto text-center mb-8">
          ...
          <div className="glass-effect border border-[#DAA520]/20 p-6 rounded">
        ...
        {featuredDemos.length > 0 && (
          <div className="mb-16">
            <AnimatedSection className="text-center mb-8">
              <div className="inline-block px-4 py-2 bg-[#4F7DF3]/10 border border-[#DAA520]/30 rounded mb-4">
                <span className="text-[#DAA520] font-medium">Featured Demo Systems</span>
              </div>
            </AnimatedSection>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
              {featuredDemos.map((demo, index) => (
                <AnimatedSection key={demo.id} variant="floatUp" delay={index * 50}>
                  <FloatingCard>
                    <div className="glass-effect border-2 border-[#DAA520]/30 p-6 rounded card-glow h-full">
                      <div className="inline-block px-3 py-1 bg-[#4F7DF3]/10 text-[#DAA520] text-xs font-medium rounded mb-4">
                        Featured Demo System
                      </div>
                      <h3 className="text-xl font-semibold mb-4 text-white">{demo.title}</h3>
                      ...
                      {demo.videoUrl && (
                        <a
                          ...
                          className="flex items-center space-x-2 text-[#DAA520] hover:text-[#3D6AE0] mb-6 transition-all duration-300 group"
                        >
                      ...
                      <div className="space-y-4 mb-6">
                        <div>
                          <span className="text-sm text-gray-300 font-medium">Problem:</span>
                          <p className="text-white mt-1 text-sm">{demo.problem}</p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-300 font-medium">System Built:</span>
                          <p className="text-white mt-1 text-sm">{demo.systemBuilt}</p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-300 font-medium">Result:</span>
                          <p className="text-white mt-1 text-sm">{demo.result}</p>
                        </div>
                      </div>
                      <button
        ...
        {standardDemos.length > 0 && (
          <div>
            <AnimatedSection className="text-center mb-8">
              <h2 className="text-2xl font-bold text-white">Additional Example Systems</h2>
            </AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {standardDemos.map((demo, index) => (
                <AnimatedSection key={demo.id} variant="floatUp" delay={index * 50}>
                  <FloatingCard>
                    <div className="glass-effect border border-[#DAA520]/20 p-6 rounded card-glow h-full">
                      <div className="inline-block px-3 py-1 bg-[#4F7DF3]/10 text-[#DAA520] text-xs font-medium rounded mb-4">
                        Demo System
                      </div>
                      <h3 className="text-xl font-semibold mb-4 text-white">{demo.title}</h3>
                      <div className="space-y-3 mb-6">
                        <div>
                          <span className="text-sm text-gray-300 font-medium">Problem:</span>
                          <p className="text-white mt-1">{demo.problem}</p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-300 font-medium">System Built:</span>
                          <p className="text-white mt-1">{demo.systemBuilt}</p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-300 font-medium">Result:</span>
                          <p className="text-white mt-1">{demo.result}</p>
                        </div>
                      </div>
                      <button
                        onClick={() => setSelectedDemo(demo)}
      ...
      {selectedDemo && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="glass-effect max-w-2xl w-full rounded p-8 max-h-[90vh] overflow-y-auto border border-[#DAA520]/20">
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="inline-block px-3 py-1 bg-[#4F7DF3]/10 text-[#DAA520] text-xs font-medium rounded mb-2">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-sm text-gray-300 font-medium mb-2">Problem</h3>
                <p className="text-white">{selectedDemo.problem}</p>
              </div>

              <div>
                <h3 className="text-sm text-gray-300 font-medium mb-2">System Built</h3>
                <p className="text-white">{selectedDemo.systemBuilt}</p>
              </div>

              <div>
                <h3 className="text-sm text-gray-300 font-medium mb-2">Result</h3>
                <p className="text-white">{selectedDemo.result}</p>
              </div>

              <div>
                <h3 className="text-sm text-gray-300 font-medium mb-3">System Features</h3>
